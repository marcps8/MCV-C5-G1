...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", default="text2img_25perc_img2txt_online_bert.pth", type=str)
    parser.add_argument("--mode", type=str, default="img2txt", choices=["text2img", "img2txt"])
    parser.add_argument("--text-model", type=str, default="bert", choices=["fasttext", "bert"])
    ...
    text_embeddings_path = OUTPUT_PATH + f"/pickles/text_embeddings_train_25perc_img2txt_bert_online.pkl"
    query_captions_path = OUTPUT_PATH + "/pickles" + f"/query_captions_img2txt_fasttext.pkl"
    query_features_path = OUTPUT_PATH + "/pickles" + f"/query_features_img2txt_fasttext.pkl"
    ...
    with open(OUTPUT_PATH + f"/pickles/results_online_img2txt_2_{args.text_model}", "wb") as f:
        pkl.dump(results, f)
