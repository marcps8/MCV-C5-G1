...
def main(load_model: bool = False, save_plots: bool = True):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load-model", 
        help="Loads model from path specified in code.", 
        action="store_true", 
        default=False
    )
    parser.add_argument(
        "--save-plots", 
        help="Stores plots to paths specified in code.", 
        action="store_true", 
        default=True
    )
