...
fold_size = train_dataset_size // NUM_FOLDS
...
for fold_idx in range(NUM_FOLDS):
    ...
    for epoch in range(EPOCHS):
        ...
        wandb.log({"fold": fold_idx + 1, "epoch": epoch + 1, "training_loss": running_loss / len(train_loader), "training_accuracy": train_accuracy})
        ...
        wandb.log({"fold": fold_idx + 1, "epoch": epoch + 1, "validation_loss": val_running_loss / len(val_loader), "validation_accuracy": val_accuracy, "learning_rate": optimizer.param_groups[0]['lr']})
